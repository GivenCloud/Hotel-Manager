...
const fetchAssignedServices = async (hotelId: string) => {
  try {
    const response = await axios.get(`http://hotel-manager.test/api/hotel/${hotelId}/services`);
    return response.data;
  } catch (error) {
...
const assignService = async (service: Service | null) => {
  ...
  try {
    await axios.post(`http://hotel-manager.test/api/hotel/${hotelId}/services`, {
      hotel_id: hotelId,
...
const removeService = async (service: Service) => {
  try {
    await axios.delete(`http://hotel-manager.test/api/hotel/${hotelId}/services`, {
      data: {
        hotel_id: hotelId,
        service_id: [service.id],
      },
